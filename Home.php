...
------------------------------------->
    <section id="Home">
        ...
        <div class="main">
            ...
            <div class="men_text">
                <div class="men_text">
                    <h1>Get<br>Delicious<br>Feed Your Savor.</h1>
                </div>
            ...
            <div class="main_image">
                <img src="images/burger.png" width="50%" height="50%">
            </div>
        ...
        <p>
            Savor the Flavors, Feed Your Cravings!
        </p>
        </div>
        <div class="main_btn">
            <a href="Menu.php" class="order">View Menu</a>
...
------------------------------------->
    <section class="section section-divider white promo">
        <div class="container">
            ...
            <!--- #promo-title-->
            <div class="Our_Menu_Categories_Title">

                <h2>Categories</h2>
                <h5><strong>Our Delicious Foods</strong></h5>
            ...
            <div class="promo-lists">
                ...
                <div class="promo-cards">
                    ...
                    <h3 class="h3 card-title">Chicken</h3>

                    <p class="card-texts">
                    Savor succulent chicken dishes, expertly spiced and cooked to perfection.
                    </p>

                    <img src="images/promo_chicken.png" width="180" height="180" loading="lazy" alt="Chicken Masala" class="w-100 card-banner">
                ...
                <div class="promo-cards">
                    ...
                    <h3 class="h3 card-title">Burger</h3>

                    <p class="card-texts">
                    Indulge in juicy burgers with fresh ingredients and delightful toppings.
                    </p>

                    <img src="images/promo_burger.png" width="180" height="180" loading="lazy" alt="Burger Kingo" class="w-100 card-banner">
                ...
                <div class="promo-cards">
                    ...
                    <h3 class="h3 card-title">Snacks</h3>

                    <p class="card-texts">
                    Enjoy crispy, flavorful bites that make snacking a delight.
                    </p>

                    <img src="images/promo_snacks.png" width="180" height="180" loading="lazy" alt="French Fry" class="w-100 card-banner">
                ...
                <div class="promo-cards">
                    ...
                    <p class="card-texts">
                    Quench your thirst with our refreshing selection of drinks, the perfect accompaniment to your meal.
                    </p>

                    <img src="images/promo_beverage.png" width="180" height="180" loading="lazy" alt="Soft Drinks" class="w-100 card-banner">
...
------------------------------------->
    ...
    <!--- #Service-title-->
    <div class="servicess_text">

        <h2>Services</h2>
        <h5><strong>Efficient online food delivery, satisfying every craving</strong></h5>
        <div class="rectangle"></div>
    </div>
    ...
    <section class="services_top">
        <div class="top">
            <h2 class="service_yellow">Why We are the Best</h2>
            <p>
            We pride ourselves on delivering the best because we source the finest ingredients and prioritize exceptional 
            quality in every dish. With CraveCrisp, you'll experience unparalleled taste and service that keeps you coming back for more.
            </p>
        </div>
    </section>
    ...
    <section class="services" id="services">
        ...
        <div class="bottom">
            ...
            <!--- #Services-box-01-->
            <div class="box">
                <img src="./images/delivery-man.svg" width="100px" height="10p0x alt=" />
                <h4>Cash on Delivery</h4>
                <p>
                Conveniently pay at your doorstep with Cash on Delivery
                </p>
            ...
            <!--- #Services-box-02-->
            <div class="box">
                <img src="./images/fast-food.svg" width="100px" height="10p0x alt=" />
                <h4>Delicious Foods</h4>
                <p>
                Savor our exquisite dishes, prepared with finest ingredients.
                </p>
            ...
            <!--- #Services-box-03-->
            <div class="box">
                <img src="./images/order-food.svg" width="100px" height="10p0x alt=" />
                <h4>Online Ordering</h4>
                <p>
                Easily order online for quick and tasty meal deliveries.
                </p>
